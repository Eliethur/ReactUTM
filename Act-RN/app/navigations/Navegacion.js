...
import RutasRestaurantes from '../../app/navigations/RutasRestaurantes'
...
export default function Navegacion() {
    return (
        <NavigationContainer>
            ...
            >
                <Tab.Screen name="Restaurantes" component={RutasRestaurantes} options={{ title: "Restaurantes", headerShown: false }} />
